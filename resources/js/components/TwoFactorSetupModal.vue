...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    ...
    return {
        ...
        description:
            'To finish enabling two-factor authentication, scan the QR code with Apple Passwords, Google Authenticator, Microsoft Authenticator, or enter the setup key manually.',
        buttonText: 'Continue',
    };
});
