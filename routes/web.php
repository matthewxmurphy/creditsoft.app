...
use App\Http\Controllers\DisputePlanController;
...
Route::middleware([AuthenticateOrAllowLocalBypass::class, 'verified'])->group(function () {
    ...
    Route::post('clients/{client}/dispute-plan', [DisputePlanController::class, 'store'])->name('clients.dispute-plan.store');
    Route::patch('clients/{client}/dispute-plan/{disputePlan}', [DisputePlanController::class, 'update'])->name('clients.dispute-plan.update');
    Route::post('clients/{client}/dispute-plan/{disputePlan}/run', [DisputePlanController::class, 'run'])->name('clients.dispute-plan.run');
    Route::post('clients/{client}/dispute-plan/{disputePlan}/steps/{step}/complete', [DisputePlanController::class, 'completeStep'])->name('clients.dispute-plan.steps.complete');
    Route::post('clients/{client}/dispute-plan/{disputePlan}/clocks/{clock}', [DisputePlanController::class, 'recordClock'])->name('clients.dispute-plan.clocks.record');
