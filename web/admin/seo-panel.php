...
$defaultOgImage = (string) ($siteSeo['default_og_image'] ?? '/assets/images/og-image.png');
$defaultOgPreviewUrl = preg_match('#^https?://#i', $defaultOgImage) === 1
    ? $defaultOgImage
    : cs_site_public_url($defaultOgImage);
?>
<section class="overview-grid<?= admin_panel_visible('seo', $panel) ?>">
    <article class="card section-card">
        ...
        <div class="social-summary-grid">
            ...
            <article class="social-summary-card">
                <strong><?= admin_escape(basename($defaultOgImage)) ?></strong>
    ...
    <form method="post" class="admin-form-grid" data-autosave="true">
        ...
        <div class="admin-form-grid is-two">
            <div class="admin-field">
                ...
                <input class="admin-input" type="text" name="default_og_image" value="<?= admin_escape($defaultOgImage) ?>">
            </div>
            <div class="admin-field">
                <label>Current fallback preview</label>
                <div class="seo-image-preview">
                    <img src="<?= admin_escape($defaultOgPreviewUrl) ?>" alt="Default OG preview" loading="lazy" decoding="async">
                </div>
            </div>
        </div>
