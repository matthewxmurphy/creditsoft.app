...
const fallbackThemePage: MarketingThemePage = {
  ...
  plansIntro: {
    eyebrow: "Pricing",
    title: "Choose monthly, annual, or the 10-year office license",
    text:
      "Monthly keeps the office flexible, annual creates the normal subscription discount, and the 10-year license is the flagship value for companies that know they are building around CreditSoft. Leasing stays available when an office wants terms.",
  },
  compareRows: [
    {
      feature: "Term",
...
const fallbackPlans: SitePlan[] = [
  {
    ...
    description:
      "For offices that want CreditSoft live now and prefer to stay month to month while the team settles into the workflow.",
    monthlyPrice: 133.27,
    saleMonthlyPrice: 99.95,
    annualPrice: 1199.4,
    annualDiscountPercent: null,
    billingLabel: "/month",
    secondaryPriceLabel: "Enterprise Pro is $169.95/month.",
    leaseTerms: [],
    highlighted: false,
    featureList: ["Unlimited users and clients", "Local intranet and client portal", "Letters and Metro2 review", "FCRA / FDCPA lawsuit intake"],
  },
  {
    id: "annual",
    name: "Annual software",
    badge: "20% annual discount",
    description:
      "For offices ready to commit for the year and keep the early adopter rate while reducing the effective monthly cost.",
    monthlyPrice: 1599.24,
    saleMonthlyPrice: 959.52,
    annualPrice: 959.52,
    annualDiscountPercent: 20,
    billingLabel: "/year",
    secondaryPriceLabel: "Enterprise Pro is $1,631.52/year.",
    leaseTerms: [],
    highlighted: false,
    featureList: ["Everything in Monthly", "Annual discount", "Enterprise Pro annual option", "Priority rollout support"],
  },
  {
    id: "ten-year",
